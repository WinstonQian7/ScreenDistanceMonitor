...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_3.setText(_translate("Dialog", "Camera Calibration - Option 1"))
        self.label_5.setText(_translate("Dialog", "Enter Displayed Distance in Inches (calibration only)"))
        self.lineEdit_6.setText(_translate("Dialog", "12"))
        self.label_15.setText(_translate("Dialog", "Enter Measured Distance in Inches (calibration only)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "Start Menu"))
        self.label_4.setText(_translate("Dialog", "Step 1 - Go to start Menu and check the camera calibration - option 1 box. Then press apply"))
        ...
        self.label_9.setText(_translate("Dialog", "Step 6 - Record the displayed distance and measured distance in the Enter Displayed/Measured Distance (calibration only) box (displayed distance may be different from measured distance) and click apply button"))
    ...
    def accept(self):
        fpath_user_settings = 'user_settings.json'
        try:
    ...
    def reset(self):
        fpath_default_settings = 'default_settings.json'
        fpath_user_settings = 'user_settings.json'
        try:
